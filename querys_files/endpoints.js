...
define(
  ...
  function() {
    return {
      ...
      'browser.signal_runtime': '/pgadmin4/browser/signal_runtime',
      ...
      'sql.format': '/pgadmin4/misc/sql/format',
      ...
      'biganimal.db_versions': '/pgadmin4/biganimal/db_versions/',

      'biganimal.instance_types': '/pgadmin4/biganimal/instance_types/<region_id>',

      'biganimal.volume_types': '/pgadmin4/biganimal/volume_types/<region_id>',

      'biganimal.volume_properties': '/pgadmin4/biganimal/volume_properties/<region_id>/<volume_type>',
      ...
      'schema_diff.compare_database': '/pgadmin4/schema_diff/compare_database/<int:trans_id>/<int:source_sid>/<int:source_did>/<int:target_sid>/<int:target_did>/<int:ignore_owner>/<int:ignore_whitespaces>',

      'schema_diff.compare_schema': '/pgadmin4/schema_diff/compare_schema/<int:trans_id>/<int:source_sid>/<int:source_did>/<int:source_scid>/<int:target_sid>/<int:target_did>/<int:target_scid>/<int:ignore_owner>/<int:ignore_whitespaces>',
